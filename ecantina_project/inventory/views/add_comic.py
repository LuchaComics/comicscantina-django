...
def search_page(request, org_id, store_id):
    return render(request, 'inventory/add/comic/view.html',{
        'org_id': org_id,
        'store_id': store_id,
        'tab':'add',
...
@login_required()
def ajax_search(request, org_id, store_id):
    ...
    return render(request, 'inventory/add/comic/list.html',{
        'issues' : issues,
    })
