...
#
    ...
    url(r'^inventory/(\d+)/(\d+)/settings/store/save_logo$', setting.ajax_edit_save_store_logo),
    url(r'^inventory/(\d+)/(\d+)/settings/store/save_data$', setting.ajax_edit_save_store_data),
