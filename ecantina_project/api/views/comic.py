...
class ComicFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Comic
        fields = ['comic_id', 'is_cgc_rated', 'age', 'cgc_rating', 'label_colour', 'condition_rating', 'is_canadian_priced_variant', 'is_variant_cover', 'is_retail_incentive_variant', 'is_newsstand_edition', 'issue', 'series', 'product', 'created', 'organization',]
