    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, null=True, unique=True, blank=True, max_length=254)),
                ('date_of_birth', models.DateField(default=datetime.datetime.now)),
                ('billing_phone', models.CharField(db_index=True, null=True, blank=True, max_length=10)),
                ...
                ('shipping_phone', models.CharField(db_index=True, null=True, blank=True, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='', blank=True, null=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(db_index=True, null=True, blank=True, max_length=255)),
                ('product_name', models.CharField(db_index=True, null=True, blank=True, max_length=511)),
                ('brand', models.ForeignKey(null=True, to='api.GCDBrand')),
                ('images', models.ManyToManyField(to='api.GCDImage', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(to='api.ImageUpload', related_name='org_header', null=True, blank=True)),
                ('logo', models.ForeignKey(to='api.ImageUpload', related_name='org_logo', null=True, blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comics_rate1', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate2', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate3', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate4', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate5', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate6', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate7', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate8', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate9', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('comics_rate10', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, null=True, blank=True, max_length=511)),
                ...
                ('discount', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
                ...
                ('price', models.DecimalField(db_index=True, default=0.0, max_digits=10, decimal_places=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(default='', blank=True, null=True, max_length=511)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(to='api.ImageUpload', related_name='store_header', null=True, blank=True)),
                ('logo', models.ForeignKey(to='api.ImageUpload', related_name='store_logo', null=True, blank=True)),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
                'db_table': 'ec_stores',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, unique=True, max_length=127)),
                ('organization', models.ForeignKey(to='api.Organization', null=True, blank=True)),
