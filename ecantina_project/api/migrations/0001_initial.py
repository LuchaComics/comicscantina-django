    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cgc_rating', models.FloatField(choices=[(10.0, 'Gem Mint'), (9.9, 'Mint'), (9.8, 'Near Mint/Mintt'), (9.6, 'Near Mint +'), (9.4, 'Near Mint'), (9.2, 'Near Mint -'), (9.0, 'Very Fine/Near Mint'), (8.5, 'Very Fine +'), (8.0, 'Very Fine'), (7.5, 'Very Fine -'), (7.0, 'Fine/Very Fine'), (6.5, 'Fine +'), (6.0, 'Fine'), (5.5, 'Fine -'), (5.0, 'Very Good/Fine'), (4.5, 'Very Good +'), (4.0, 'Very Good'), (3.5, 'Very Good -'), (3.0, 'Good/Very Good'), (2.5, 'Good +'), (2.0, 'Good'), (1.8, 'Good -'), (1.5, 'Fair/Good'), (1.0, 'Fair'), (0.5, 'Poor')], null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_key', models.CharField(default='', max_length=63)),
                ('first_name', models.CharField(max_length=63, db_index=True)),
                ('last_name', models.CharField(max_length=63, db_index=True)),
                ('email', models.EmailField(null=True, blank=True, max_length=254, db_index=True, unique=True)),
                ('billing_name', models.CharField(max_length=126)),
                ('billing_phone', models.CharField(null=True, max_length=10, db_index=True, blank=True)),
                ...
                ('shipping_phone', models.CharField(null=True, max_length=10, db_index=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(null=True, max_length=255, db_index=True, blank=True)),
                ('product_name', models.CharField(null=True, max_length=511, db_index=True, blank=True)),
                ('brand', models.ForeignKey(null=True, to='api.GCDBrand')),
                ('images', models.ManyToManyField(to='api.GCDImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_count', models.DecimalField(decimal_places=3, max_digits=10, null=True, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comics_rate1', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate2', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate3', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate4', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate5', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate6', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate7', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate8', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate9', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('comics_rate10', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(null=True, max_length=511, db_index=True, blank=True)),
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Comic'), (2, 'Furniture'), (3, 'Coin')], default=1, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ...
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, db_index=True)),
                ...
                ('images', models.ManyToManyField(to='api.ImageUpload', blank=True, related_name='product_images')),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(null=True, max_length=254, blank=True)),
                ('billing_name', models.CharField(null=True, max_length=126, blank=True)),
                ...
                ('shipping_name', models.CharField(null=True, max_length=126, blank=True)),
                ...
                ('products', models.ManyToManyField(to='api.Product', blank=True, related_name='receipt_products')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(to='api.StoreShippingRate', db_index=True, blank=True, related_name='store_shipping_rates'),
        ),
        migrations.AddField(
            model_name='storeshippingpreference',
            name='store',
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ManyToManyField(to='api.Tag', db_index=True, blank=True, related_name='product_tags'),
        ),
        migrations.AddField(
            model_name='orgshippingpreference',
            name='rates',
            field=models.ManyToManyField(to='api.OrgShippingRate', db_index=True, blank=True, related_name='ord_shipping_rates'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='gcdbrand',
            name='group',
            field=models.ManyToManyField(db_table='gcd_brand_emblem_group', blank=True, to='api.GCDBrandGroup'),
        ),
        migrations.AddField(
            model_name='gcdbrand',
            name='images',
