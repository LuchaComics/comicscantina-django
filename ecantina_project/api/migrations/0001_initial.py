    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cgc_rating', models.FloatField(null=True, blank=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], choices=[(10.0, 'Gem Mint'), (9.9, 'Mint'), (9.8, 'Near Mint/Mint'), (9.6, 'Near Mint +'), (9.4, 'Near Mint'), (9.2, 'Near Mint -'), (9.0, 'Very Fine/Near Mint'), (8.5, 'Very Fine +'), (8.0, 'Very Fine'), (7.5, 'Very Fine -'), (7.0, 'Fine/Very Fine'), (6.5, 'Fine +'), (6.0, 'Fine'), (5.5, 'Fine -'), (5.0, 'Very Good/Fine'), (4.5, 'Very Good +'), (4.0, 'Very Good'), (3.5, 'Very Good -'), (3.0, 'Good/Very Good'), (2.5, 'Good +'), (2.0, 'Good'), (1.8, 'Good -'), (1.5, 'Fair/Good'), (1.0, 'Fair'), (0.5, 'Poor')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(null=True, blank=True, unique=True, max_length=254, db_index=True)),
                ('date_of_birth', models.DateField(default=datetime.datetime.now)),
                ('billing_phone', models.CharField(null=True, blank=True, max_length=10, db_index=True)),
                ...
                ('shipping_phone', models.CharField(null=True, blank=True, max_length=10, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)], choices=[(0, 'Owner'), (1, 'Manager'), (2, 'Worker')])),
                ('is_verified', models.BooleanField(default=False)),
                ('verification_key', models.CharField(blank=True, default='', max_length=63)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(null=True, default='', blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(null=True, blank=True, max_length=255, db_index=True)),
                ('product_name', models.CharField(null=True, blank=True, max_length=511, db_index=True)),
                ('brand', models.ForeignKey(null=True, to='api.GCDBrand')),
                ('images', models.ManyToManyField(blank=True, to='api.GCDImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_count', models.DecimalField(null=True, decimal_places=3, max_digits=10, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(10)], choices=[(1, 'Feedback'), (2, 'Error'), (3, 'Checkout'), (4, 'Inventory'), (5, 'Pull List'), (6, 'Sales'), (7, 'Emailing List'), (8, 'Store Settings / Users'), (9, 'Dashboard')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(max_length=4, choices=[('png', 'Portable Network Graphics (PNG)'), ('jpeg', 'Joint Photographic Experts Group picture (JPEG)'), ('jpg', 'Joint Photographic Experts Group picture (JPG)'), ('bmp', 'Bitmap Image File (BMP)'), ('tiff', 'Tagged Image File Format (TIFF)'), ('gif', 'Graphics Interchange Format (GIF)')], db_index=True)),
                ('mime_type', models.CharField(default='image/jpeg', max_length=15, choices=[('image/png', 'PNG'), ('image/jpeg', 'JPEG/JPG'), ('image/bmp', 'BMP'), ('image/tiff', 'TIFF'), ('image/gif', 'GIF')], db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(null=True, related_name='org_header', blank=True, to='api.ImageUpload')),
                ('logo', models.ForeignKey(null=True, related_name='org_logo', blank=True, to='api.ImageUpload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.PositiveSmallIntegerField(null=True, blank=True, validators=[django.core.validators.MinValueValidator(4), django.core.validators.MaxValueValidator(840)], choices=[(124, 'Canada'), (840, 'United States'), (484, 'Mexico')])),
                ('comics_rate1', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate2', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate3', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate4', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate5', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate6', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate7', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate8', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate9', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('comics_rate10', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(null=True, blank=True, max_length=511, db_index=True)),
                ('type', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], choices=[(1, 'Comic'), (2, 'Furniture'), (3, 'Coin')])),
                ...
                ('sub_price', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('has_tax', models.BooleanField(default=True)),
                ('tax_rate', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('tax_amount', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('sub_price_with_tax', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('discount', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('discount_type', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(2)], choices=[(1, '%'), (2, '$')])),
                ('price', models.DecimalField(default=0.0, decimal_places=2, max_digits=10, db_index=True)),
                ...
                ('images', models.ManyToManyField(blank=True, to='api.ImageUpload', related_name='product_images')),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(null=True, default='', blank=True, max_length=511)),
                ('has_purchased_online', models.BooleanField(default=False)),
                ('payment_method', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(9)], choices=[(1, 'Cash'), (2, 'Debit Card'), (3, 'Credit Card'), (4, 'Gift Card'), (5, 'Store Points'), (6, 'Cheque'), (7, 'PayPal'), (8, 'Invoice'), (9, 'Other')])),
                ('status', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(6)], choices=[(1, 'New Order'), (2, 'Picked'), (3, 'Shipped'), (4, 'Received'), (5, 'In-Store Sale'), (6, 'Online Sale')], db_index=True)),
                ...
                ('tax_rate', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('tax_amount', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('sub_total_with_tax', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ('discount_amount', models.DecimalField(default=0.0, decimal_places=2, max_digits=10)),
                ...
                ('error', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], choices=[(0, 'No Error'), (1, 'Cancelled Online Order')])),
                ('customer', models.ForeignKey(null=True, blank=True, to='api.Customer')),
                ('employee', models.ForeignKey(null=True, blank=True, to='api.Employee')),
                ('organization', models.ForeignKey(null=True, blank=True, to='api.Organization')),
                ('products', models.ManyToManyField(blank=True, to='api.Product', related_name='receipt_products')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('is_suspended', models.BooleanField(default=False)),
                ('tax_rate', models.DecimalField(default=0.13, decimal_places=2, max_digits=10)),
                ('street_name', models.CharField(max_length=63)),
                ('street_number', models.CharField(null=True, blank=True, max_length=31)),
                ('unit_number', models.CharField(null=True, blank=True, max_length=15)),
                ('city', models.CharField(max_length=63)),
                ...
                ('header', models.ForeignKey(null=True, related_name='store_header', blank=True, to='api.ImageUpload')),
                ('logo', models.ForeignKey(null=True, related_name='store_logo', blank=True, to='api.ImageUpload')),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
                'db_table': 'ec_stores',
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(blank=True, to='api.StoreShippingRate', related_name='store_shipping_rates', db_index=True),
        ),
        migrations.AddField(
            model_name='storeshippingpreference',
            name='store',
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ManyToManyField(blank=True, to='api.Tag', related_name='product_tags', db_index=True),
        ),
        migrations.AddField(
            model_name='orgshippingpreference',
            name='rates',
            field=models.ManyToManyField(blank=True, to='api.OrgShippingRate', related_name='ord_shipping_rates', db_index=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='employee',
            name='profile',
            field=models.ForeignKey(null=True, blank=True, to='api.ImageUpload', on_delete=django.db.models.deletion.SET_NULL),
        ),
        migrations.AddField(
            model_name='employee',
            name='user',
