    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(unique=True, null=True, max_length=254, db_index=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(default=0, choices=[(0, 'Owner'), (1, 'Manager'), (2, 'Worker')], validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)])),
                ('is_verified', models.BooleanField(default=False)),
                ('verification_key', models.CharField(default='', max_length=63, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='', null=True, max_length=255, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.PositiveSmallIntegerField(default=1, choices=[(1, 'Feedback'), (2, 'Error'), (3, 'Checkout'), (4, 'Inventory'), (5, 'Pull List'), (6, 'Sales'), (7, 'Emailing List'), (8, 'Store Settings / Users'), (9, 'Dashboard')], validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(10)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, db_index=True, primary_key=True)),
                ...
                ('mime_type', models.CharField(default='image/jpeg', choices=[('image/png', 'PNG'), ('image/jpeg', 'JPEG/JPG'), ('image/bmp', 'BMP'), ('image/tiff', 'TIFF'), ('image/gif', 'GIF')], max_length=15, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comics_rate1', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate2', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate3', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate4', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate5', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate6', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate7', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate8', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate9', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('comics_rate10', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(default=1, choices=[(1, 'Comic'), (2, 'Furniture'), (3, 'Coin')], validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ...
                ('discount_type', models.PositiveSmallIntegerField(default=1, choices=[(1, '%'), (2, '$')], validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(2)])),
                ('price', models.DecimalField(default=0.0, max_digits=10, db_index=True, decimal_places=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(default='', null=True, max_length=511, blank=True)),
                ('has_purchased_online', models.BooleanField(default=False)),
                ('payment_method', models.PositiveSmallIntegerField(default=1, choices=[(1, 'Cash'), (2, 'Debit Card'), (3, 'Credit Card'), (4, 'Gift Card'), (5, 'Store Points'), (6, 'Cheque'), (7, 'PayPal'), (8, 'Invoice'), (9, 'Other')], validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(9)])),
                ('status', models.PositiveSmallIntegerField(default=1, choices=[(1, 'New Order'), (2, 'Picked'), (3, 'Shipped'), (4, 'Received'), (5, 'In-Store Sale'), (6, 'Online Sale')], db_index=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(6)])),
                ...
                ('error', models.PositiveSmallIntegerField(default=0, choices=[(0, 'No Error'), (1, 'Cancelled Online Order')], validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ('customer', models.ForeignKey(null=True, blank=True, to='api.Customer')),
                ('employee', models.ForeignKey(null=True, blank=True, to='api.Employee')),
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(to='api.StoreShippingRate', related_name='store_shipping_rates', db_index=True, blank=True),
        ),
        migrations.AddField(
            model_name='storeshippingpreference',
            name='store',
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ManyToManyField(to='api.Tag', related_name='product_tags', db_index=True, blank=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(to='api.OrgShippingRate', related_name='ord_shipping_rates', db_index=True, blank=True),
        ),
        migrations.AddField(
