    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(null=True, choices=[(1, 'Gold'), (2, 'Silver'), (3, 'Bronze'), (4, 'Copper')], blank=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(4)])),
                ('cgc_rating', models.FloatField(null=True, choices=[(10.0, 'Gem Mint'), (9.9, 'Mint'), (9.8, 'Near Mint/Mint'), (9.6, 'Near Mint +'), (9.4, 'Near Mint'), (9.2, 'Near Mint -'), (9.0, 'Very Fine/Near Mint'), (8.5, 'Very Fine +'), (8.0, 'Very Fine'), (7.5, 'Very Fine -'), (7.0, 'Fine/Very Fine'), (6.5, 'Fine +'), (6.0, 'Fine'), (5.5, 'Fine -'), (5.0, 'Very Good/Fine'), (4.5, 'Very Good +'), (4.0, 'Very Good'), (3.5, 'Very Good -'), (3.0, 'Good/Very Good'), (2.5, 'Good +'), (2.0, 'Good'), (1.8, 'Good -'), (1.5, 'Fair/Good'), (1.0, 'Fair'), (0.5, 'Poor')], blank=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('label_colour', models.CharField(max_length=63, choices=[('Purple', 'Purple'), ('Red', 'Red'), ('Blue', 'Blue'), ('Yellow', 'Yellow')], blank=True, null=True)),
                ('condition_rating', models.PositiveSmallIntegerField(null=True, choices=[(10, 'Near Mint'), (8, 'Very Fine'), (6, 'Fine'), (4, 'Very Good'), (2, 'Good'), (1, 'Fair'), (0, 'Poor')], blank=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, null=True, blank=True, db_index=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_name', models.CharField(max_length=511, null=True, blank=True, db_index=True)),
                ('brand', models.ForeignKey(to='api.GCDBrand', null=True)),
                ('images', models.ManyToManyField(blank=True, to='api.GCDImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mime_type', models.CharField(max_length=15, choices=[('image/png', 'PNG'), ('image/jpeg', 'JPEG/JPG'), ('image/bmp', 'BMP'), ('image/tiff', 'TIFF'), ('image/gif', 'GIF')], default='image/jpeg', db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(blank=True, to='api.ImageUpload', related_name='org_header', null=True)),
                ('logo', models.ForeignKey(blank=True, to='api.ImageUpload', related_name='org_logo', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.PositiveSmallIntegerField(null=True, choices=[(124, 'Canada'), (840, 'United States'), (484, 'Mexico')], blank=True, validators=[django.core.validators.MinValueValidator(4), django.core.validators.MaxValueValidator(840)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(db_index=True, choices=[(1, 'Comic'), (2, 'Furniture'), (3, 'Coin')], default=1, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ...
                ('image', models.ForeignKey(blank=True, to='api.ImageUpload', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('purchased', models.DateTimeField(db_index=True, blank=True, null=True)),
                ('comment', models.CharField(max_length=511, blank=True, default='', null=True)),
                ...
                ('status', models.PositiveSmallIntegerField(db_index=True, choices=[(1, 'New Order'), (2, 'Picked'), (3, 'Shipped'), (4, 'Received'), (5, 'In-Store Sale'), (6, 'Online Sale')], default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(6)])),
                ...
                ('shipping_phone', models.CharField(max_length=10, blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monday_to', models.CharField(max_length=5, choices=[('08:00', '08:00'), ('08:30', '08:30'), ('09:00', '09:00'), ('09:30', '09:30'), ('10:00', '10:00'), ('10:30', '10:30'), ('11:00', '11:00'), ('11:30', '11:30'), ('12:00', '12:00'), ('12:30', '12:30'), ('13:00', '13:00'), ('13:30', '13:30'), ('14:00', '14:00'), ('14:30', '14:30'), ('15:00', '15:00'), ('15:30', '15:30'), ('16:00', '16:00'), ('16:30', '16:30'), ('17:00', '17:00'), ('17:30', '17:30'), ('18:00', '18:00'), ('18:30', '18:30'), ('19:00', '19:00'), ('19:30', '19:30'), ('20:00', '20:00'), ('20:30', '20:30'), ('21:00', '21:00'), ('21:30', '21:30'), ('22:00', '22:00'), ('22:30', '22:30')], blank=True, null=True)),
                ...
                ('header', models.ForeignKey(blank=True, to='api.ImageUpload', related_name='store_header', null=True)),
                ('logo', models.ForeignKey(blank=True, to='api.ImageUpload', related_name='store_logo', null=True)),
                ('organization', models.ForeignKey(to='api.Organization')),
            ],
            options={
                'db_table': 'ec_stores',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=127, null=True, blank=True, db_index=True, unique=True)),
                ('organization', models.ForeignKey(blank=True, to='api.Organization', null=True)),
                ('store', models.ForeignKey(blank=True, to='api.Store', null=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(db_index=True, blank=True, related_name='store_shipping_rates', to='api.StoreShippingRate'),
        ),
        migrations.AddField(
            model_name='storeshippingpreference',
            name='store',
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ManyToManyField(db_index=True, blank=True, related_name='product_tags', to='api.Tag'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(db_index=True, blank=True, related_name='ord_shipping_rates', to='api.OrgShippingRate'),
        ),
        migrations.AddField(
