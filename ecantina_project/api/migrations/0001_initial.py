    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cgc_rating', models.FloatField(choices=[(10.0, 'Gem Mint'), (9.9, 'Mint'), (9.8, 'Near Mint/Mint'), (9.6, 'Near Mint +'), (9.4, 'Near Mint'), (9.2, 'Near Mint -'), (9.0, 'Very Fine/Near Mint'), (8.5, 'Very Fine +'), (8.0, 'Very Fine'), (7.5, 'Very Fine -'), (7.0, 'Fine/Very Fine'), (6.5, 'Fine +'), (6.0, 'Fine'), (5.5, 'Fine -'), (5.0, 'Very Good/Fine'), (4.5, 'Very Good +'), (4.0, 'Very Good'), (3.5, 'Very Good -'), (3.0, 'Good/Very Good'), (2.5, 'Good +'), (2.0, 'Good'), (1.8, 'Good -'), (1.5, 'Fair/Good'), (1.0, 'Fair'), (0.5, 'Poor')], validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, max_length=254, unique=True, null=True, blank=True)),
                ('date_of_birth', models.DateField(default=datetime.datetime.now)),
                ('billing_phone', models.CharField(db_index=True, max_length=10, null=True, blank=True)),
                ...
                ('shipping_phone', models.CharField(db_index=True, max_length=10, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(max_length=255, default='', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_name', models.CharField(db_index=True, max_length=511, null=True, blank=True)),
                ('brand', models.ForeignKey(to='api.GCDBrand', null=True)),
                ('images', models.ManyToManyField(to='api.GCDImage', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_count', models.DecimalField(db_index=True, decimal_places=3, null=True, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mime_type', models.CharField(db_index=True, max_length=15, choices=[('image/png', 'PNG'), ('image/jpeg', 'JPEG/JPG'), ('image/bmp', 'BMP'), ('image/tiff', 'TIFF'), ('image/gif', 'GIF')], default='image/jpeg')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.PositiveSmallIntegerField(choices=[(124, 'Canada'), (840, 'United States'), (484, 'Mexico')], validators=[django.core.validators.MinValueValidator(4), django.core.validators.MaxValueValidator(840)], blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=511, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(max_length=511, default='', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=127, unique=True, null=True, blank=True)),
                ('organization', models.ForeignKey(blank=True, to='api.Organization', null=True)),
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(db_index=True, related_name='store_shipping_rates', blank=True, to='api.StoreShippingRate'),
        ),
        migrations.AddField(
            model_name='storeshippingpreference',
            name='store',
        ...
        migrations.AddField(
            ...
            name='rates',
            field=models.ManyToManyField(db_index=True, related_name='ord_shipping_rates', blank=True, to='api.OrgShippingRate'),
        ),
        migrations.AddField(
